...
/// Block type for BitBuf blocks. Widened from u32 → u64 in Phase 1 of the Go port
/// to match the Go side and enable native-word broadword `select64`. All block-level
/// arithmetic in dense.rs / sparse.rs / waveletmatrix.rs goes through
/// `bitbuf::Block::BITS`, `block_index`, and `block_bit_index` and was already
/// width-agnostic.
